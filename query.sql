...
ADD COLUMN if not EXISTS reinvest TINYINT(1) NOT NULL DEFAULT 0 AFTER amount,
ADD COLUMN if not EXISTS is_received TINYINT(1) NOT NULL DEFAULT 0 AFTER reinvest;
...
ALTER TABLE admin
ADD COLUMN IF NOT EXISTS firstname VARCHAR(100) DEFAULT NULL after token,
ADD COLUMN IF NOT EXISTS lastname VARCHAR(100) DEFAULT NULL after firstname,
